...
public class Translation2d implements ITranslation2d<Translation2d> {
  ...
  public Translation2d normalize() {
    if (epsilonEquals(identity(), Util.EPSILON_VALUE)) return this;
   ...
   * given that u and v share a starting point. tl;dr: _* u /| / | / | v *---+---------------->*
   * \___/ | scal_v(u) u.scal(v)
   *
   * @return (u . v) / norm(v)
   */
  ...
  public boolean isWithinAngle(
      Translation2d A, Translation2d B, Translation2d C, boolean vertical) {
