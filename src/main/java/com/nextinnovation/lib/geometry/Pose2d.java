...
public class Pose2d implements IPose2d<Pose2d> {
  ...
  public Pose2d translateBy(final Translation2d other) {
    return new Pose2d((translation_.translateBy(other)), rotation_);
  }

  public Pose2d rotationByOtherWithOwnCenter(final Rotation2d other) {
    return new Pose2d(translation_, rotation_.rotateBy(other));
  }
